...
#include "/home/ahmed/projects/manipulator_robot/arduinobot_ws/src/arduinobot_contol/include/arduinobot_interface.h"
                                                                ...
                                                                names_{"joint_1", "joint_2", "joint_3", "joint_4"}
{
    ...
    hardware_srv_ = pnh_.serviceClient<arduinobot_contol::AngleConvert>("/radians_to_degrees");
...
void ArduinobotInterface::write(ros::Duration elapsed_time)
{
    ...
    arduinobot_contol::AngleConvert srv;
