...
class AngleConvertRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AngleConvertRequest
...
class AngleConvertResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AngleConvertResponse
    // Serialize message field [base]
    bufferOffset = _serializer.float64(obj.base, buffer, bufferOffset);
    // Serialize message field [shoulder]
    bufferOffset = _serializer.float64(obj.shoulder, buffer, bufferOffset);
...
module.exports = {
  ...
  datatype() { return 'arduinobot_controller/AngleConvert'; }
};
