...
class ArduinobotTaskActionActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new ArduinobotTaskActionGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArduinobotTaskActionGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ArduinobotTaskActionActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = ArduinobotTaskActionGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArduinobotTaskActionActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ArduinobotTaskActionGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ArduinobotTaskActionGoal()
    }
...
module.exports = ArduinobotTaskActionActionGoal;
