...
"""autogenerated by genpy from arduinobot_remote/ArduinobotTaskActionResult.msg. Do not edit."""
import codecs
import sys
...
class ArduinobotTaskActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "arduinobot_remote/ArduinobotTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arduinobot_remote/ArduinobotTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArduinobotTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = arduinobot_remote.msg.ArduinobotTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = arduinobot_remote.msg.ArduinobotTaskResult()
